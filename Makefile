...
SRC     = src/main.c src/scatter.c src/util.c src/deflate.c \
...
$(UNIT): tests/unit.c src/util.o src/deflate.o src/scatter.o
	@mkdir -p tests/build
	$(CC) $(CFLAGS) -Isrc -o $@ tests/unit.c src/util.o src/deflate.o src/scatter.o
